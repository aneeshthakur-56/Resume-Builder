                    ...
                    {data.personal_info?.image && typeof data.personal_info.image === 'string' ? (
                        <div className="mb-6">
                            <img 
                                ...
                                alt="Profile" 
                                className="w-32 h-32 object-cover rounded-full mx-auto transition-all" 
                                style={{ 
                                    background: data.personal_info?.removeBackground ? accentColor : 'transparent' 
                                }} 
                            />
                        </div>
                    ) : (
                                    ...
                                    <div key={index}>
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="text-xs text-zinc-500">
                                                ...
                                                {exp.isCurrent || exp.is_current ? "Present" : formatDate(exp.end_date)}
                                            </span>
                                        </div>
